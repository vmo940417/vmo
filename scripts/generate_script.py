...
영상 길이는 20초 내외입니다. 시청자가 아침에 이 영상을 보고
...
- script: 실제로 소리 내어 읽을 문구. 아래 3단 구조를 따른다.
  1) 첫 문장: 공감가는 짧은 후킹 문장 (아침의 감정, 흔한 고민 등으로 시작)
  2) 중간: 오늘의 핵심 명언 또는 명언풍 문장 (이 대본의 중심)
  3) 마지막 문장: 짧고 힘 있는 응원/다짐으로 마무리
  예: "눈뜨자마자 한숨부터 나오는 날 있죠. 하지만 완벽하지 않아도 괜찮아요,
  시작하는 것만으로 이미 반은 성공이니까요. 오늘도 그 용기 하나로 시작해봐요."
- script 전체 길이는 공백 포함 90~140자 사이로 작성한다 (20초 낭독 기준, 절대 넘기지 말 것).
- 각 문장은 짧고 구어체로, 밝고 긍정적이며 힘이 나는 톤을 유지한다. 존댓말(해요체)을 사용한다.
